...
class CursoController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        //Prueba de la relacion uno a muchos
        // $cursos=Curso::with(['user'])->orderBy('id','DESC')->get();
        // return $cursos; //funciona correctamente

        //Pruena de muchos a muchos
        // $cursos=Curso::with(['user','profesores'])->orderBy('id','DESC')->get();
        //return $cursos; //funciona correctamente
        //dd($cursos);
